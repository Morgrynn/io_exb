...
function getUser() {
  ...
  xmlUsers.open(
    "GET",
    "http://localhost/io_exb/controller/get_user.php?id=" + id
  );
  xmlUsers.send();
}

function addUser() {
  var url = "http://localhost/io_exb/controller/add_user.php";
...
function updateUser() {
  var url = "http://localhost/io_exb/controller/update_user.php";
  var xhttp = new XMLHttpRequest();
  xhttp.open("POST", url, true);
...
function deleteUser() {
  ...
  xmlUsers.open(
    "GET",
    "http://localhost/io_exb/controller/delete_user.php?id=" + id
  );
  xmlUsers.send();
}
